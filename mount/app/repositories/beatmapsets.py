...
class BeatmapsetsRepo:
    ...
    READ_PARAMS = """\
        ...
        mapper_id, mapper_name, video, download_disabled,
        availability_information, bpm, can_be_hyped, discussion_locked,
        current_hype, required_hype, is_scoreable, legacy_thread_url,
        current_nominations, required_nominations, ranked_status, storyboard,
    ...
    async def create(self, beatmapset_id: int, artist: str, artist_unicode: str,
                     ...
                     mapper_id: int, mapper_name: str, video: bool, download_disabled: bool,
        ...
        query = """\
            INSERT INTO beatmapsets (
                ...
                title, title_unicode, mapper_id, mapper_name, video,
                download_disabled, availability_information, bpm, can_be_hyped,
                discussion_locked, current_hype, required_hype, is_scoreable,
                ...
                :favourite_count, :nsfw, :osu_play_count, :preview_url, :source,
                :title, :title_unicode, :mapper_id, :mapper_name, :video,
                :download_disabled, :availability_information, :bpm,
                :can_be_hyped, :discussion_locked, :current_hype,
                :required_hype, :is_scoreable, :legacy_thread_url,
